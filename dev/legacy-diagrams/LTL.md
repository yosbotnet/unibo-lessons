...
Fault/error/failure terminology, combinatorial counts, a concrete inductive proof
and historical application claims were subsequently handled in
[PROOF-COUNTS.md](PROOF-COUNTS.md). No paid generation or
