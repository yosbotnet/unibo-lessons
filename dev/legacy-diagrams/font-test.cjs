...
(async()=>{const r=await createRenderer();try{
 ...
 assets.push(...require('./robustness-sources.cjs').map(e=>'cybersecurity/assets/diagrams/'+e.id+'.svg'),'cybersecurity/assets/diagrams/cyber-feature-sensitivity.svg','cybersecurity/assets/diagrams/cyber-model-to-impact.svg','cybersecurity/assets/diagrams/cyber-policy-trajectories.svg');
 assets.push('cybersecurity/assets/diagrams/cyber-privacy-provenance.svg');
 assets.push('cybersecurity/assets/diagrams/cyber-dp-scope.svg','cybersecurity/assets/diagrams/cyber-dp-distributions.svg');
 assets.push('cybersecurity/assets/diagrams/cyber-agent-enforcement.svg');
 assets.push('cybersecurity/assets/diagrams/cyber-leakage-aggregation.svg');
 assets.push('cybersecurity/assets/diagrams/cyber-injection-channels.svg');
 assets.push('cybersecurity/assets/diagrams/cyber-incident-responsibilities.svg');
 assets.push('oa/assets/diagrams/oa-testing-workflow.svg');
