...
@@PARTS@@
  ...
  <section class="idx-part">
    <div class="idx-part-head"><span class="idx-part-num">+</span><h2>Bonus</h2></div>
    <ol class="idx-list">
      <li><a href="../play/gpu/index.html"><span class="idx-num">GPU</span><span class="idx-title">GPU kernels: a campaign (experiment, in English). Data parallelism on a GPU: warps, coalescing, shared memory, barriers.</span><span class="idx-meta">~70 min</span></a></li>
    </ol>
  </section>
